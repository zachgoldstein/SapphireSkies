package org.flixel
{
	...
	public class FlxObject extends FlxRect
	{
		...
		/**
		 *	Add variable to this property to dynamically add things to FlxObjects (ZACHG)
		 */
		public var dataObject:Object = new Object();
		/**
		 *	Add unique identifiers to help when looking for specific objects (ZACHG)
		 */
		public var uid:int;
		/**
...
*/		}
		...
		public function collideCallback(Object:FlxObject=null,Callback:Function=null):Boolean
		{
			return FlxU.collideCallback(this,((Object==null)?this:Object),Callback);
		}
