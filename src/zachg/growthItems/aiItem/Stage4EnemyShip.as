package zachg.growthItems.aiItem
{
	...
	public class Stage4EnemyShip extends AiItem
	{
		...
		override public function setStats():void
		{
			...
			levelShipShotDamage = [75/damageDivider,160/damageDivider,450/damageDivider];
			levelShipShotDelay = [5*delayDivider,2*delayDivider,10*delayDivider];
		}
		
		public function Stage4EnemyShip(Id:int)
		{
			super(Id);
