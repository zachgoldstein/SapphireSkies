package zachg.growthItems.aiItem
{
	...
	public class Stage5EnemyShip extends AiItem
	{
		...
		override public function setStats():void
		{
			...
			levelShipShotDamage = [100/damageDivider,160/damageDivider,450/damageDivider];
			levelShipShotDelay = [5*delayDivider,2*delayDivider,10*delayDivider];
		}		
		
		public function Stage5EnemyShip(Id:int)
		{
			super(Id);
			...
			villageResourceGrowth = [0.062,0.114,0.166];
			villageHealth = [9000,9600,12500];
